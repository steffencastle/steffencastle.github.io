...
::: {.timeline-item}
**2025–2026**  
**Hallucination detection from source-specific attention writes**  
Decomposing each attention head's residual write into context and response contributions to detect unsupported RAG answers (BlackboxNLP 2026).
:::
